   ...
   public void voterReg()
   {
	   ...
	   try {
		   ...
		   try {
			   ...
			   System.out.println("Please write in that YYYY-MM-DD formate:");
			   DateDob(name);   
		   }catch(Exception e2) {
			   try {
			   System.err.println("Invalid Date Formate");
			   ...
			   System.err.println("Sorry date formate is wrong");
		     //e3.printStackTrace();
    ...
    if(check==true) {
    	...
    	System.err.println("Voter Id is invalid");
    }
    }
    public void Candidatereg() {
    	CandidateReg c=new CandidateReg (101, "Iron Man", "Satara", "NCP", "karad", 33);
    	CandidateReg c1=new CandidateReg (102, "Spider Man", "Pune", "BJP", "karad", 23);
    	CandidateReg c2=new CandidateReg (103, "Super Man", "Mumbai", "AAP", "karad", 33);
    ...
    public void result() {
    	...
    	for(CandidateReg i:candidateData) {
    		if(max==i.getVote()) {
    			...
    			System.out.println("ID:"+i.getId() + " Name:"+i.getName()+"  Vote:"+i.getVote());
    			if(j>1) {
    				System.out.println("candidate vote are same");
    			}
    		}
    	}
    }
